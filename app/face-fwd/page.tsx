...
// Your imports
import faceFwd from "../../component/assets/Images/face-fwd.png";
import jewellryImg1 from "../../component/assets/Images/jewellry-img1.png";
import faceFwd2 from "../../component/assets/Images/face-fwd2.png";
    ...
    <p className="text-gray-700 text-lg leading-relaxed font-medium mb-10 font-inter text-[#3D3D3D]">
      ...
      <section className="max-w-7xl 2xl:max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-12 py-12">
        <div className="rounded-3xl overflow-hidden shadow-xl">
          <Image src={faceFwd2} alt="Conference Display" className="w-full h-auto object-cover" />
        </div>
      </section>
